...
class Fuse(fuse.Operations):
    ...
    def read(self, path, length, offset, info=None):
        ...
        return self.core.route4(self.core.read, path, length, offset, info)
